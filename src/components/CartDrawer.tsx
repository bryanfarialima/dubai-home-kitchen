      ...
      <SheetContent className="w-full sm:max-w-md flex flex-col bg-card">
        ...
        {items.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center gap-3">
            ...
            <p className="text-muted-foreground font-display font-semibold">Your cart is empty</p>
          ...
          <>
            ...
            <div className="border-t border-border pt-4 space-y-3">
              ...
              >
                Checkout — AED {totalPrice.toFixed(2)}
              </button>
              <button
                onClick={clearCart}
                className="w-full text-sm text-muted-foreground hover:text-accent font-display transition-colors"
              >
                Clear Cart
              </button>
            </div>
